...
// content setup
const texts = [
  ["Home", "We create Homes"],
  ["Luxury", "Finest luxury interior"],
  ["Tower", "Unmatched architexture"],
  ["Residencial", "Building with purpose"],
  ["The Office ", "State of art building"],
];
...
rgbKineticSlider = new rgbKineticSlider({
  ...
  textTitleColor: "#fefefe", // title color
